...
description "Header of .ETL log files created on a 32-bit OS"
...
begin
		move -24
	section	"Event Trace Log Header (x86)"
		...
		uint32     "EventsLost"
		uint32     "CPUSpeed (MHz)"
		uint32     "LoggerName: pointerValue"
		uint32     "LogFileName: pointerValue"
		move 4
